...
<head>
        ...
        <!-- Perfect Scrollbar -->
        <link type="text/css" href="<?php echo base_url(); ?>assets/css/perfect-scrollbar.css" rel="stylesheet">
        ...
        <link type="text/css" href="<?php echo base_url(); ?>assets/bootstraps/css/bootstrap.min.css" rel="stylesheet">
        <link type="text/css" href="<?php echo base_url(); ?>assets/vendor/summernote/summernote.min.css" rel="stylesheet">
                    ...
                    <div class="navbar navbar-expand-sm navbar-main navbar-dark bg-dark  pr-0"
                        ...
                        <div class="container-fluid p-0">
                            ...
                            <form class="search-form d-none d-sm-flex flex"
                                  action="https://demo.frontted.com/flowdash/120/index.html">
                                <button class="btn"
                            ...
                            <ul class="nav navbar-nav d-none d-sm-flex border-left navbar-height align-items-center">
                                <li class="nav-item dropdown">
                                    <a href="#account_menu"
                                       ...
                                       data-caret="false">
                                        <span class="mr-1 d-flex-inline">
                                            <span class="text-light"><?php echo $this->session->userdata('nama'); ?></span>
                                        </span>
                                    ...
                                    <div id="account_menu"
                                        ...
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item"
                                           href="<?php echo base_url('Logout'); ?>"><i class="material-icons">exit_to_app</i> Logout</a>
                                    </div>
                                </li>
                            </ul>
                                ...
                                <div class="flex">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item"><?php echo $j_menu; ?></li>
                                            <li class="breadcrumb-item active"
                                                aria-current="page"><?php echo $judul; ?></li>
                                        </ol>
                                    </nav>
