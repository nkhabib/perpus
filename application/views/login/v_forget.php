 			...
 			<div class="card-body text-dark">
				...
				<?php endif;?>
 				<div class="text-center">
			 		...
			 		<form action="<?php echo base_url('login/login/forget'); ?>" method="POST" >
					  ...
					  <button type="submit" class="btn btn-primary btn-sm btn-block"><h6>Reset</h6></button>
					</form>
					
					<small><a href="<?php echo base_url('login/login/login'); ?>">Kembali Login</a></small>
				</div>
			</div>
		</div>
 	</div>
