                        ...
                        <div class="container-fluid page__container">
                            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#tambah_petugas"><i class="fas fa-plus-square fa-fw"></i>Tambah Petugas</button>
                            <div class="row">
                                <div class="col-md">
                                <div class="card">
                                    ...
                                    <table class="table mb-0 thead-border-top-0 table-striped">
                                        ...
                                        <tbody class="list"
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $no; ?></td>
                                                <td><?php echo $p['id_number']; ?></td>
                                                <td><?php echo $p['nama']; ?></td>
                                                <td><?php echo $p['alamat']; ?></td>
                                                <td><?php echo $p['email']; ?></td>
                                                <td class="text-center">
                                                    <a href="<?php echo base_url('admin/admin/editPetugas/'.base64_encode($p['id'])); ?>" class="badge badge-pill badge-warning" style="font-size: 9px;">Edit</a>
                                                                                                        
                                                    <a href="<?php echo base_url('admin/admin/hapusPetugas/'.base64_encode($p['id'])); ?>" class="badge badge-pill badge-danger hapus" style="font-size: 9px;">hapus</a>
                                                </td>
                                            </tr>         
                                            <?php $no++; endforeach; ?> 
                        ...
                        <div class="px-3">
                            ...
                            <form action="<?php echo base_url('admin/admin/input_admin'); ?>" method="POST">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="Petugas" disabled>
